...
cta:
  eyebrow: "The Hanamachi After Dark"
  heading: "See the district properly,<br />not through a lens"
  body: "Standing on Hanamikoji waiting for a photo is the worst way to experience the geisha district. Our Gion Sake Walk covers the same streets with the context that makes them make sense."
...
Kyoto's geisha districts are working neighborhoods, not attractions, and the difference matters — maiko and geiko are on their way to appointments, not on display. This guide explains who you are actually looking at, where and when you might see them, and the photography rules that carry real fines in Gion.
